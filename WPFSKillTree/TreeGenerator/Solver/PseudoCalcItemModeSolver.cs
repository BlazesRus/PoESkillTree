...
namespace PoESkillTree.TreeGenerator.Solver
{
    ...
    public class PseudoCalcItemModeSolver : AbstractGeneticSolver<PseudoCalcSolverSettings>
    {
        ...
        /// </summary>
        private void FormalizeConstraints(Dictionary<string, Tuple<float, double, bool>> attrConstraints,
            IReadOnlyCollection<ConvertedPseudoCalcCon> pseudoConstraints)
        {
            _attrConstraints = new Tuple<float, double, bool>[attrConstraints.Count + pseudoConstraints.Count];
        ...
        private List<ConvertedPseudoCalcCon> EvalPseudoAttrConstraints()
        {
            ...
            var convertedPseudos = new List<ConvertedPseudoCalcCon>(Settings.PseudoAttributeConstraints.Count);
            ...
            foreach (var pair in Settings.PseudoAttributeConstraints)
            {
                ...
                var convPseudo = new ConvertedPseudoCalcCon(convAttrs, pair.Value);
