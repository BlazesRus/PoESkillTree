...
{
    /// <summary>
    /// Data class for settings for AdvancedSolver variant.
    /// </summary>
    public class PseudoCalcSolverSettings : SolverSettings
    {
        ...
        /// </summary>
        public readonly Dictionary<string, Tuple<float, double, bool>> AttributeConstraints;
        ...
        /// Weight must be between 0 and 1 (both inclusive).
        /// </summary>
        public readonly Dictionary<PseudoAttribute, Tuple<float, double, bool>> PseudoAttributeConstraints;
        ...
        /// <summary>
        /// The item information equipped in skill-tree(Shared inside Static Instance)
        /// </summary>
        ...
        public PseudoCalcSolverSettings(SolverSettings baseSettings,
            int totalPoints,
            Dictionary<string, float> initialAttributes,
            Dictionary<string, Tuple<float, double, bool>> attributeConstraints,
            Dictionary<PseudoAttribute, Tuple<float, double, bool>> pseudoAttributeConstraints,
            ...
            : base(baseSettings)
        {
            ...
            Tags = tags;
            OffHand = offHand;
            AttributeConstraints = attributeConstraints ?? new Dictionary<string, Tuple<float, double, bool>>();
            PseudoAttributeConstraints = pseudoAttributeConstraints ?? new Dictionary<PseudoAttribute, Tuple<float, double, bool>>();
